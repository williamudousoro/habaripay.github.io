...
:::info
This service is only available to Select Registered Businesses in Nigeria. To be verified, kindly contact growth@squadco.com and copy william.udousoro@habaripay.com
:::

:::caution
You need to create a Sandbox account to test all your integrations before live deployment.
[Click Here](https://sandbox.squadco.com/login) to start.
:::
