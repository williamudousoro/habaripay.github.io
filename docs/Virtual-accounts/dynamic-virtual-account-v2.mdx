...
<button
  href="#"
  className="group w-full bg-transparent border border-solid border-gray-200 flex p-5 rounded hover:shadow-sm hover:cursor-pointer"
>
  <a className="flex">
    <div>
    ...
    <div className="pl-4 text-gray-950 dark:text-white">
      <p className="p-0 m-0 hover:text-sm group-hover:text-blue-600">
        API Specifications
      </p>
